...
#
#   Description: Implelemtation of the Kalman Filter algorithm handling post processing data 
#              Post processing is done by ignoring USBL mesurements corresponding to the 
