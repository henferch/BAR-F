...
#
#   Description: Implelemtation of the algorithm 'Augmented-MCL' as defined in Thrun et al. 2005.
#              -------------------------------------------------------------------------
...
function filterProcessing(t)
    ...
    if (newMeasurement ==  true)           
      ...
      %allRandSel = [allRandSel pRandSel];

      for m = 1 : M
        r = rand(1);      
        if(r <= pRandSel)
          rPose = rand(ns,1)-0.5;
          %sampledPose= rPose.*workspaceOffset;
